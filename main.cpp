...
/* What I Changed:
  - low and high variables to keep track of the range in which i is being
 performed.
 - calculated the mid index as the average of low and high.
 - check if the item at the mid index is equal to i. if yes, returned the
 mid index indicating that the i is found.
 ...
 - if the search completes and the item is not found, returned -1 */
